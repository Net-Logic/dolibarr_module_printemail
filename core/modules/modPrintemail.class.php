...
class modPrintemail extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		/*
		$langs->load("printemail@printemail");
		$this->export_code[$r]=$this->rights_class.'_'.$r;
		$this->export_label[$r]='MyObjectLines';	// Translation key (used only if key ExportDataset_xxx_z not found)
		$this->export_icon[$r]='myobject@printemail';
		// Define $this->export_fields_array, $this->export_TypeFields_array and $this->export_entities_array
		$keyforclass = 'MyObject'; $keyforclassfile='/printemail/class/myobject.class.php'; $keyforelement='myobject@printemail';
		include DOL_DOCUMENT_ROOT.'/core/commonfieldsinexport.inc.php';
		//$this->export_fields_array[$r]['t.fieldtoadd']='FieldToAdd'; $this->export_TypeFields_array[$r]['t.fieldtoadd']='Text';
		//unset($this->export_fields_array[$r]['t.fieldtoremove']);
		//$keyforclass = 'MyObjectLine'; $keyforclassfile='/printemail/class/myobject.class.php'; $keyforelement='myobjectline@printemail'; $keyforalias='tl';
		//include DOL_DOCUMENT_ROOT.'/core/commonfieldsinexport.inc.php';
		$keyforselect='myobject'; $keyforaliasextra='extra'; $keyforelement='myobject@printemail';
		include DOL_DOCUMENT_ROOT.'/core/extrafieldsinexport.inc.php';
		//$keyforselect='myobjectline'; $keyforaliasextra='extraline'; $keyforelement='myobjectline@printemail';
		//include DOL_DOCUMENT_ROOT.'/core/extrafieldsinexport.inc.php';
		...
		$this->import_icon[$r]='myobject@printemail';
		$this->import_tables_array[$r] = array('t' => MAIN_DB_PREFIX.'printemail_myobject', 'extra' => MAIN_DB_PREFIX.'printemail_myobject_extrafields');
		...
		$this->import_fieldshidden_array[$r] = array('extra.fk_object' => 'lastrowid-'.MAIN_DB_PREFIX.'printemail_myobject');
		...
		$this->import_convertvalue_array[$r] = array(
			't.ref' => array(
				'rule'=>'getrefifauto',
				'class'=>(empty(getDolGlobalString('PRINTEMAIL_MYOBJECT_ADDON')) ? 'mod_myobject_standard' : getDolGlobalString('PRINTEMAIL_MYOBJECT_ADDON')),
				'path'=>"/core/modules/commande/".(empty(getDolGlobalString('PRINTEMAIL_MYOBJECT_ADDON')) ? 'mod_myobject_standard' : getDolGlobalString('PRINTEMAIL_MYOBJECT_ADDON')).'.php'
				'classobject'=>'MyObject',
				'pathobject'=>'/printemail/class/myobject.class.php',
			),
	...
	public function init($options = '')
	{
		...
		//$result1=$extrafields->addExtraField('printemail_myattr1', "New Attr 1 label", 'boolean', 1,  3, 'thirdparty',   0, 0, '', '', 1, '', 0, 0, '', '', 'printemail@printemail', 'isModEnabled("printemail")');
		//$result2=$extrafields->addExtraField('printemail_myattr2', "New Attr 2 label", 'varchar', 1, 10, 'project',      0, 0, '', '', 1, '', 0, 0, '', '', 'printemail@printemail', 'isModEnabled("printemail")');
		//$result3=$extrafields->addExtraField('printemail_myattr3', "New Attr 3 label", 'varchar', 1, 10, 'bank_account', 0, 0, '', '', 1, '', 0, 0, '', '', 'printemail@printemail', 'isModEnabled("printemail")');
		//$result4=$extrafields->addExtraField('printemail_myattr4', "New Attr 4 label", 'select',  1,  3, 'thirdparty',   0, 1, '', array('options'=>array('code1'=>'Val1','code2'=>'Val2','code3'=>'Val3')), 1,'', 0, 0, '', '', 'printemail@printemail', 'isModEnabled("printemail")');
		//$result5=$extrafields->addExtraField('printemail_myattr5', "New Attr 5 label", 'text',    1, 10, 'user',         0, 0, '', '', 1, '', 0, 0, '', '', 'printemail@printemail', 'isModEnabled("printemail")');
		...
		// Document templates
		$moduledir = dol_sanitizeFileName('printemail');
		$myTmpObjects = [];
